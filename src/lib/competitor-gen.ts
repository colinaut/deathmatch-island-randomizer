...
const initialReaction = [
	"I have no idea where I am or what I'm doing, but I'm excited to find out.",
	"I have no idea where I am or what I'm doing, and I'm terrified.",
	"This is a game, and I'm going to learn the rules.",
	"This is a game, and I'm going to make friends and followers.",
	"I know exactly what we're doing here (and I happen to be completely wrong).",
	"I know exactly what we're doing here (and I happen to be completely right, or close enough)."
];
...
const motivation: Motivation[] = [
	{ type: 'Sabotage', description: "You're here with a secret purpose—you want to find out more about Deathmatch Island, and stop it once and for all." },
	{ type: 'Survival', description: 'You just want to get out of here and get home.' },
	{ type: 'Victory', description: 'You desperately need to win this game.' },
	{ type: 'Just Vibes', description: 'You find it hard to take all this seriously, and you just want to have a good time and enjoy yourself.' },
	{ type: 'Fame', description: 'You want the most followers at the end of this.' },
	{ type: 'Money', description: 'You desperately need money, and lots of it.' },
	{ type: 'Bitterness', description: 'You have a tendency to punish those closest to you.' },
	{ type: 'Connection', description: "You're missing emotional connection in your life." },
	{ type: 'Confidence', description: 'A situation like this is your chance to find your inner strength.' },
	{ type: 'Redemption', description: 'A situation like this is your chance to redeem yourself.' },
	{ type: 'Conspiracy', description: "You can't help yourself—you need to see behind the curtain." },
	{ type: 'Control', description: 'You have a deep need to be the one in charge.' }
];

const randomItem = <T>(array: T[]): T => array[Math.floor(Math.random() * array.length)];

function getRandomCompetitor(): Record<string, string> {
...
function getRandomMotivation(): Motivation {
	return randomItem(motivation);
}

function getRandomReaction(): string {
	return randomItem(initialReaction);
}

export { firstNames, surnames, occupation, eyes, build, hair, detail, initialReaction, motivation, getRandomCompetitor, getRandomMotivation, getRandomReaction };
